...
@section('main-content')
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p>
                        <a class="btn btn-info" href="{{ route('propietarios.create') }}" role="button">
                            Crear
                        </a>
                    </p>
            ...
            <p>
                <a class="btn btn-info" href="{{ route('relacion.index') }}" role="button">
                    Continuar
                </a>
            </p>
        </div>
    ...
    {!! Form::open(['route' => ['propietarios.destroy', ':TIPO_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
