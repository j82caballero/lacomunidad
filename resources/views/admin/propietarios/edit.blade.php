...
@section('pageheader')
    ...
    <h3 class="page-title"> Propietarios
        <small>Editar</small>
    </h3>
    @endsection
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Propietarios</span>
                                </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        ...
                                        {!! Form::model($propietario, ['route' => ['propietarios.update', $propietario->id], 'method' => 'PUT']) !!}
                                            ...
                                            <a href="{{ redirect()->back()->getTargetUrl() }}" class="btn btn-info">Cancelar</a>
