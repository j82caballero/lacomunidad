...
@section('main-content')
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @include('admin.contabilidad.gastos.partials.table')
    ...
    {!! Form::open(['route' => ['gastos.destroy', ':TIPO_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
        ...
        $(document).ready(function () {
            $('.btn-delete').click(function (e) {
                ...
                $.post(url, data, function (result) {
                    ...
                    $('#modal-texto').text('El gasto no fue eliminado');
                    $('#myModal').modal('show');
