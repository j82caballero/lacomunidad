...
@section('pageheader')
    ...
    <h3 class="page-title"> Propiedades + Propietarios
        <small>Crear</small>
    </h3>
    @endsection
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Propiedades + Propietarios</span>
                                </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        ...
                                        {!! Form::open(['route' => 'relacion.store', 'method' => 'POST']) !!}
                                            ...
                                            @include('admin.relacion.partials.fields')
                                            ...
                                            <a href="{{ route('relacion.index') }}" class="btn btn-info">Cancelar</a>
